...
<div class="quienesSomos">
  ...
  <div class='texto'>
    ...
    <p>
      Nuesta Web quiere acercar el mundo del deporte y la comida sana a todo el mundo que quiere empezar y no puede permitirse un entrenador o un gimnasio, o simplemente dispone del tiempo suficiente 
      para poder entrenar, ademas de aportar ideas sobre comidas saludables faciles de hacer y paso a paso, para que no tengan perdida a la hora de hacerlas.
    </p>
    <p>
      En esta web da igual si eres un pro del deporte, un novato que quiere empezar o llevas toda la vida compitiendo a nivel profesional, aqui hay sitio para todo elmundo que quiera llevar una vida mas sana.
    </p>
    <p>
